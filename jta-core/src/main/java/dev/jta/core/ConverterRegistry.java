...
public final class ConverterRegistry {
    ...
    public ConverterRegistry() {
        ...
        register(Double.class, Double::parseDouble);
        register(boolean.class, ConverterRegistry::parseCheckboxAwareBoolean);
        register(Boolean.class, ConverterRegistry::parseCheckboxAwareBoolean);
    ...
    /**
     * Converte o valor cru de um booleano vindo da requisicao.
     *
     ...
     *
     * <p>Vive aqui (e nao no {@code ComponentInvoker}, de onde veio na
     * fase de correcao de bugs) para que as duas vias de entrada de dados
     * da requisicao - campo de estado e argumento de acao
     * ({@code __jtaArgN}) - passem exatamente pelo mesmo conversor e nunca
